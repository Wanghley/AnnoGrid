...
echo "     (e.g. bind_mounts/homarr__data -> docker/application-server/homarr/data)."
...
echo "  4. Bring stacks up in order: db -> app -> mon, then the standalone stacks"
echo "     (core-data, n8n, twenty, tandoor, obsidian, homarr, portainer, peekaping, homepage)."
